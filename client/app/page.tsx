				...
				<section className="rounded-2xl border border-zinc-900 bg-zinc-950/45 p-5 shadow-(--ot-shadow-soft)">
					<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
						<div>
							...
							<p className="mt-1 max-w-2xl text-sm leading-6 text-zinc-500">
								Assigned work, live activity, and conversations stay in one
								preserved context.
							</p>
						</div>
						<Button
					...
					<div className="mt-5 grid gap-3 sm:grid-cols-3">
						<div className="rounded-xl border border-zinc-900 bg-zinc-950/55 p-4">
							<p className="ot-label">Assigned</p>
							<p className="mt-2 text-2xl font-semibold text-zinc-100">
								{assignedTasks.length}
							</p>
						</div>
						<div className="rounded-xl border border-zinc-900 bg-zinc-950/55 p-4">
							<p className="ot-label">In motion</p>
							<p className="mt-2 text-2xl font-semibold text-violet-300">
								{activeTasks.length}
							</p>
						</div>
						<div className="rounded-xl border border-zinc-900 bg-zinc-950/55 p-4">
							<p className="ot-label">Total tasks</p>
							<p className="mt-2 text-2xl font-semibold text-zinc-100">
								{tasks.length}
							</p>
						</div>
