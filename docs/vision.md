...
| **19** | **File & Attachment Hub**     | Supabase integrated file uploads for tasks and projects.                                                                                                             | File attachment UI, global project files tab, and useFilesData hooks for uploading and deleting files.                                               | ✅ Done |
| **20** | **Presentation & Timeline View**| Gantt calculation logic using date-fns based on `startDate` and `dueDate`.                                                                                           | Full-screen CSS Grid Gantt chart with today auto-scrolling, glassmorphic task bars, assignees, and priorities.                                       | ✅ Done |

---

## 🔮 What's Next (Office Hub Initiatives)

Our immediate roadmap focuses on optimizing the assignment and reporting workflows, while continuing to replace our office's reliance on Excel and PowerPoint:

| Priority  | Feature                         | Scope              | Details                                                                                                                                                                                              |
| :-------- | :------------------------------ | :----------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔴 High   | **Time Tracking**               | Backend + Frontend | **(Replaces Excel)** Allow users to log time on tasks. Essential for management to monitor actual progress versus estimated effort and see precise time spent in daily reports.                      |
...
| 🟡 Medium | **Global Search**               | Backend + Frontend | Full-text search across tasks, comments, and activity events within a workspace to quickly find assigned tasks or past reports.                                                                      |
